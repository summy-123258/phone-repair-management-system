<template>
  <div class="app-container">
    ...
    <el-table v-if="refreshTable" v-loading="loading" :data="deptList" row-key="id" :default-expand-all="isExpandAll"
      ...
      <el-table-column prop="name" label="门店名称" width="150" align="center"></el-table-column>
      <el-table-column prop="address" label="详细地址" width="250" align="center"></el-table-column>
      <el-table-column prop="phone" label="门店联系电话" width="120" align="center"></el-table-column>
      <el-table-column prop="leader" label="店长" align="center" :formatter="userNicknameFormat" width="120"/>
      <el-table-column prop="leaderPhone" label="店长电话" width="120" align="center"></el-table-column>
      <el-table-column prop="businessHours" label="营业时间" width="120" align="center"></el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="店长" prop="leaderUserId">
              <el-select v-model="form.leaderUserId" placeholder="请输入店长" clearable style="width: 100%">
          ...
          <el-col :span="12">
            <el-form-item label="门店联系电话" prop="phone">
              <el-input v-model="form.phone" placeholder="请输入门店联系电话" maxlength="11" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="店长电话" prop="leaderPhone">
              <el-input v-model="form.leaderPhone" placeholder="请输入店长电话" maxlength="11" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="营业时间" prop="businessHours">
              <el-input v-model="form.businessHours" placeholder="请输入营业时间，例如：09:00-21:00" maxlength="20" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
