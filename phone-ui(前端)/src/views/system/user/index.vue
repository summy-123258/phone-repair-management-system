...
<!--          <el-table-column label="用户编号" align="center" key="id" prop="id" v-if="columns[0].visible" />-->
          ...
          <el-table-column label="员工名称" align="center" key="nickname" prop="nickname" v-if="columns[2].visible" :show-overflow-tooltip="true" />
          ...
          <el-col :span="12">
            <el-form-item label="归属门店" prop="deptId">
              <treeselect v-model="form.deptId" :options="deptOptions" :show-count="true" :clearable="false"
                          placeholder="请选择归属门店" :normalizer="normalizer"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
