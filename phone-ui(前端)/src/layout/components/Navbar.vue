  ...
  <div class="navbar">
    ...
    <div class="right-menu">
      <template v-if="device!=='mobile'">
        ...
        <div class="user-role-info right-menu-item">
          <span v-if="deptName" class="dept-name">{{ deptName }}</span>
          <span v-if="roleText" class="role-text">{{ roleText }}</span>
        </div>
  ...
  computed: {
    ...
    roleText() {
      ...
      if (this.roles && this.roles.length > 0) {
        return roleMap[this.roles[0]] || this.roles[0]
      }
      return ''
    },
    setting: {
