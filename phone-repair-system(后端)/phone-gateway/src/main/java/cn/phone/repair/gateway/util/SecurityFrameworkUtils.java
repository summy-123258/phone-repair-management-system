package cn.phone.repair.gateway.util;

import cn.hutool.core.map.MapUtil;
import cn.phone.repair.framework.common.util.json.JsonUtils;
import cn.phone.repair.gateway.filter.security.LoginUser;
 ...
 * 安全服务工具类
 *
 * copy from phone-spring-boot-starter-security 的 SecurityFrameworkUtils 类
 *
 * @author 芋道源码
 */
@Slf4j
