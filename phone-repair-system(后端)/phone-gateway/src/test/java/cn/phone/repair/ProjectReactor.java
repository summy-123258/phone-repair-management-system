...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.phone.repair";
    private static final String ARTIFACT_ID = "phone";
    private static final String PACKAGE_NAME = "cn.phone.repair";
    private static final String TITLE = "手机维修管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        //Maven groupId的命名，标识项目所属的组织或公司
        String groupIdNew = "cn.phone.repair";
        //Maven artifactId，项目名称/模块名
        String artifactIdNew = "phone";
        //包名
        String packageNameNew = "cn.phone.repair";
        // 项目的标题
        String titleNew = "手机维修管理系统";
        String projectBaseDirNew = "D:\\thesis\\code\\phone-repair-system"; // 一键改名后，“新”项目所在的目录
