package cn.phone.repair.module.infra.service.logger;
...
import cn.phone.repair.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.phone.repair.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.phone.repair.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.phone.repair.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.phone.repair.framework.common.util.date.LocalDateTimeUtils.*;
...
import static cn.phone.repair.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.phone.repair.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("phone-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("phone-test");
