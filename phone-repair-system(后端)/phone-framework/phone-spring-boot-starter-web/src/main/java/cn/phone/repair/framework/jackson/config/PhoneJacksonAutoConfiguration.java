package cn.phone.repair.framework.jackson.config;

import cn.phone.repair.framework.common.util.json.JsonUtils;
import cn.phone.repair.framework.common.util.json.databind.NumberSerializer;
import cn.phone.repair.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import cn.phone.repair.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class PhoneJacksonAutoConfiguration {
