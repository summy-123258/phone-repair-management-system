package cn.phone.repair.framework.web.config;
...
import cn.phone.repair.framework.web.core.filter.CacheRequestBodyFilter;
import cn.phone.repair.framework.web.core.filter.DemoFilter;
import cn.phone.repair.framework.web.core.handler.GlobalExceptionHandler;
import cn.phone.repair.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class PhoneWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "phone.demo", havingValue = "true")
