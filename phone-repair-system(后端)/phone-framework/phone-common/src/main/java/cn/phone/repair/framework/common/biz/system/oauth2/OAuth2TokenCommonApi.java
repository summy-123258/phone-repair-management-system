package cn.phone.repair.framework.common.biz.system.oauth2;

import cn.phone.repair.framework.common.enums.RpcConstants;
...
public interface OAuth2TokenCommonApi {
    ...
    @Parameters({
        ...
        @Parameter(name = "clientId", description = "客户端编号", required = true, example = "phoneyuanma")
    })
