package cn.phone.repair.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import cn.phone.repair.framework.common.util.json.JsonUtils;
import cn.phone.repair.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${phone.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class PhoneMybatisAutoConfiguration {
