...
import cn.phone.repair.framework.mybatis.core.util.MyBatisUtils;
import cn.phone.repair.framework.redis.config.PhoneCacheProperties;
import cn.phone.repair.framework.security.core.service.SecurityFrameworkService;
import cn.phone.repair.framework.tenant.core.aop.TenantIgnore;
import cn.phone.repair.framework.tenant.core.aop.TenantIgnoreAspect;
import cn.phone.repair.framework.tenant.core.db.TenantDatabaseInterceptor;
import cn.phone.repair.framework.tenant.core.job.TenantJobAspect;
import cn.phone.repair.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import cn.phone.repair.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import cn.phone.repair.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import cn.phone.repair.framework.tenant.core.redis.TenantRedisCacheManager;
import cn.phone.repair.framework.tenant.core.security.TenantSecurityWebFilter;
import cn.phone.repair.framework.tenant.core.service.TenantFrameworkService;
import cn.phone.repair.framework.tenant.core.service.TenantFrameworkServiceImpl;
import cn.phone.repair.framework.tenant.core.web.TenantContextWebFilter;
import cn.phone.repair.framework.tenant.core.web.TenantVisitContextInterceptor;
...
public class PhoneTenantAutoConfiguration {
    ...
    public TenantFrameworkService tenantFrameworkService(TenantCommonApi tenantApi) {
        // 参见 https://gitee.com/zhijiantianya/phone-cloud/issues/IC6YZF
        try {
     ...
     */
    @Configuration
    @ConditionalOnClass(name = "cn.phone.repair.framework.mq.redis.core.RedisMQTemplate")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     PhoneCacheProperties phoneCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(phoneCacheProperties.getRedisScanBatchSize()));
