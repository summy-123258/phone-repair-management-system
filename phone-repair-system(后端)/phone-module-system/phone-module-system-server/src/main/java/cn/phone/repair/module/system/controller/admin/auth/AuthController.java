package cn.phone.repair.module.system.controller.admin.auth;
...
import cn.phone.repair.framework.security.config.SecurityProperties;
...
import cn.phone.repair.module.system.service.auth.AdminAuthService;
...
import cn.phone.repair.module.system.service.social.SocialClientService;
...
public class AuthController {
    ...
    public CommonResult<AuthPermissionInfoRespVO> getPermissionInfo() {
        ...
        if (user.getDeptId() != null) {
            try {
                cn.phone.repair.module.system.dal.dataobject.dept.DeptDO dept = deptService.getDept(user.getDeptId());
                if (dept != null) {
