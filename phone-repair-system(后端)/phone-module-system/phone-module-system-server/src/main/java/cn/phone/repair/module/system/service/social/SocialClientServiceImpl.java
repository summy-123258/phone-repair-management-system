package cn.phone.repair.module.system.service.social;
...
import cn.phone.repair.framework.common.util.cache.CacheUtils;
import cn.phone.repair.framework.common.util.http.HttpUtils;
import cn.phone.repair.framework.common.util.object.BeanUtils;
import cn.phone.repair.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.phone.repair.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import cn.phone.repair.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import cn.phone.repair.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.phone.repair.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.phone.repair.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.phone.repair.module.system.dal.dataobject.social.SocialClientDO;
import cn.phone.repair.module.system.dal.mysql.social.SocialClientMapper;
import cn.phone.repair.module.system.dal.redis.RedisKeyConstants;
import cn.phone.repair.module.system.enums.social.SocialTypeEnum;
import cn.phone.repair.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.phone.repair.framework.common.util.collection.MapUtils.findAndThen;
import static cn.phone.repair.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.phone.repair.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static cn.phone.repair.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${phone.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${phone.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/phone-cloud/pulls/230
