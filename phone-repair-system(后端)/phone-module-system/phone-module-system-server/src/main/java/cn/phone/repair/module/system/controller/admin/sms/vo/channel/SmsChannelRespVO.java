package cn.phone.repair.module.system.controller.admin.sms.vo.channel;
...
public class SmsChannelRespVO {
    ...
    @Schema(description = "短信 API 的账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "phone")
