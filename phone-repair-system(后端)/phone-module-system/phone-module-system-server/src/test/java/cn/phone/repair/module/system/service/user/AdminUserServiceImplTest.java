package cn.phone.repair.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.phone.repair.framework.common.enums.CommonStatusEnum;
import cn.phone.repair.framework.common.exception.ServiceException;
import cn.phone.repair.framework.common.pojo.PageResult;
import cn.phone.repair.framework.common.util.collection.ArrayUtils;
import cn.phone.repair.framework.common.util.collection.CollectionUtils;
import cn.phone.repair.framework.test.core.ut.BaseDbUnitTest;
import cn.phone.repair.module.infra.api.config.ConfigApi;
import cn.phone.repair.module.infra.api.file.FileApi;
import cn.phone.repair.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.phone.repair.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.phone.repair.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.phone.repair.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.phone.repair.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.phone.repair.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import cn.phone.repair.module.system.dal.dataobject.dept.DeptDO;
import cn.phone.repair.module.system.dal.dataobject.dept.PostDO;
import cn.phone.repair.module.system.dal.dataobject.dept.UserPostDO;
import cn.phone.repair.module.system.dal.dataobject.tenant.TenantDO;
import cn.phone.repair.module.system.dal.dataobject.user.AdminUserDO;
import cn.phone.repair.module.system.dal.mysql.dept.UserPostMapper;
import cn.phone.repair.module.system.dal.mysql.user.AdminUserMapper;
import cn.phone.repair.module.system.enums.common.SexEnum;
import cn.phone.repair.module.system.service.dept.DeptService;
import cn.phone.repair.module.system.service.dept.PostService;
import cn.phone.repair.module.system.service.oauth2.OAuth2TokenService;
import cn.phone.repair.module.system.service.permission.PermissionService;
...
import static cn.phone.repair.framework.common.util.collection.SetUtils.asSet;
import static cn.phone.repair.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.phone.repair.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.phone.repair.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.phone.repair.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.phone.repair.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.phone.repair.framework.test.core.util.RandomUtils.*;
import static cn.phone.repair.module.system.enums.ErrorCodeConstants.*;
import static cn.phone.repair.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn(success("phoneyuanma"));
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("phoneyuanma");
        ...
        assertEquals("phoneyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("phoneyuanma"))).thenReturn("java");
