...
import cn.phone.repair.module.system.enums.ApiConstants;
...
import static cn.phone.repair.module.system.api.user.AdminUserApi.PREFIX;
...
public interface AdminUserApi extends AutoTransable<AdminUserRespDTO> {
    ...
    @Parameter(name = "mobile", description = "手机号码", example = "13800138000", required = true)
    ...
    @Operation(summary = "通过昵称模糊查询用户列表")
    @Parameter(name = "nickname", description = "用户昵称", example = "张三", required = true)
    ...
    CommonResult<Long> createUser(@RequestBody AdminUserSaveReqDTO createReqDTO);

    @PostMapping("/update")
    @Operation(summary = "更新用户")
    CommonResult<Boolean> updateUser(@RequestBody AdminUserSaveReqDTO updateReqDTO);
